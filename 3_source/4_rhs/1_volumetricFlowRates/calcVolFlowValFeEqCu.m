...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Function   : calcVolFlowValFeEqCu.m
%Source     : common
...
function volFlowRat = calcVolFlowValFeEqCu(params,col,~,~,~,nS,nCo)

    %---------------------------------------------------------------------%    
    %Define known quantities
    
    %Name the function ID
    %funcId = 'calcVolFlowValFeEqCu.m';      
    ...
    %Calculate the volumetric flow rate coming out from the feed-end of the
    %adsorber
