...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Function   : plotExTaPresProfiles.m
%Source     : common
%Description: plot the pressure profile for the extract product tank
%Inputs     : params       - a struct containing simulation parameters
%             sol          - a struct containing simulation outputs
%Outputs    : the pressure profile for all product tanks
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function plotExTaPresProfiles(params,sol)

    %---------------------------------------------------------------------%
    %Define known quantities
    
    %Name the function ID
    %funcId = 'plotExTaPresProfiles';
    ...
    for i = 1 : lastStep  
        ...
        pressure = sol.(append('Step',int2str(i))).exTa.n1.gasConsTot ...
                .* gConScaleFac ...
                .* sol.(append('Step',int2str(i))).exTa.n1.temps.cstr ...
                .* teScaleFac ...
                .* gasCons;
