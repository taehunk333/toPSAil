...
%Outputs    : exTaTemps    - a struct containing nTemp fields where each of
%                            them represents dimensionless temperature of 
%                            a product tank (e.g. CSTR temperature or wall
%                            temperature)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function exTaTemps = convert2ExTaTemps(params,states,varargin)
  
    %---------------------------------------------------------------------%
    %Define known quantities
    
    %Name the function ID
    %funcId = 'convert2ExTaTemps.m';
    ...
    for i = 1 : nTemp      
        ...
        exTaTemps.(sTemp{i}) = exTaStates(:,nComs+i);
