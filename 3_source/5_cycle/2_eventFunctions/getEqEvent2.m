...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Function   : getEqEvent2.m
%Source     : common
%Description: This is the second type of an event function for pressure 
...
function [event,isterminal,direction] = getEqEvent2(params,~,states,nS,~)

    %---------------------------------------------------------------------%
    %Define known quantities
    
    %Define function ID
    %funcId = 'getEqEvent2.m';
