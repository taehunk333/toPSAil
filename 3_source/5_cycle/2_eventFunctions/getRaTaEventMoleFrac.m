...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Function   : getRaTaEventMoleFrac.m
%Source     : common
%Description: This is an event function that triggers when the mole
%             fraction inside the raffinate tank reaches a prespecified 
%             threshold value.
...
function [event,isterminal,direction] ...
    = getRaTaEventMoleFrac(params,~,states)

    %---------------------------------------------------------------------%
    %Define known quantities
    
    %Define function ID
    %funcId = 'getRaTaEventMoleFrac.m';
