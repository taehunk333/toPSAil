...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Function   : getRtEvent2.m
%Source     : common
%Description: This is the second type of an event function for rest. The
...
function [event,isterminal,direction] = getRtEvent2(params,~,states,nS,~)

    %---------------------------------------------------------------------%
    %Define known quantities
    
    %Define function ID
    %funcId = 'getRtEvent2.m';
