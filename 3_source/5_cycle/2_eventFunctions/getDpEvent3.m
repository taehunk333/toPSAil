...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Function   : getDpEvent3.m
%Source     : common
%Description: This is the third type of an event function for 
%             depressurization. The event criteria is (TBD)
...
function [event,isterminal,direction] = getDpEvent3(params,~,states,nS,~)

    %---------------------------------------------------------------------%
    %Define known quantities
    
    %Define function ID
    %funcId = 'getDpEvent3.m';
